...
// Lucerna application
extern unsigned char tinyled_smt_start[]  asm("_binary_tinyled_smt_start");
extern unsigned char tinyled_smt_end[]  asm("_binary_tinyled_smt_end");
...
struct st_thingjs_ext_app preinstalled_applications[PREINSTALLED_APPS_NUMBER] = {
        ...
        // TinyLED preset application
        { .path = "/tinyled.smt",    .start = tinyled_smt_start, .end = tinyled_smt_end }
};
